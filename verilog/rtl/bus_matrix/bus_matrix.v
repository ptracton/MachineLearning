...
wb_mux
  #(.num_slaves (6),
    .MATCH_ADDR ({32'h90000000, 32'h90002000, 32'h90004000, 32'h90006000, 32'h80000000, 32'h90000000}),
...
wb_arbiter
 ...
 wb_arbiter_dsp_slave
   (.wb_clk_i  (wb_clk_i),
    .wb_rst_i  (wb_rst_i),
    .wbm_adr_i ({wb_m2s_daq_master_dsp_slave_adr, wb_m2s_dsp_master_dsp_slave_adr}),
    .wbm_dat_i ({wb_m2s_daq_master_dsp_slave_dat, wb_m2s_dsp_master_dsp_slave_dat}),
    .wbm_sel_i ({wb_m2s_daq_master_dsp_slave_sel, wb_m2s_dsp_master_dsp_slave_sel}),
    .wbm_we_i  ({wb_m2s_daq_master_dsp_slave_we, wb_m2s_dsp_master_dsp_slave_we}),
    .wbm_cyc_i ({wb_m2s_daq_master_dsp_slave_cyc, wb_m2s_dsp_master_dsp_slave_cyc}),
    .wbm_stb_i ({wb_m2s_daq_master_dsp_slave_stb, wb_m2s_dsp_master_dsp_slave_stb}),
    .wbm_cti_i ({wb_m2s_daq_master_dsp_slave_cti, wb_m2s_dsp_master_dsp_slave_cti}),
    .wbm_bte_i ({wb_m2s_daq_master_dsp_slave_bte, wb_m2s_dsp_master_dsp_slave_bte}),
    .wbm_dat_o ({wb_s2m_daq_master_dsp_slave_dat, wb_s2m_dsp_master_dsp_slave_dat}),
    .wbm_ack_o ({wb_s2m_daq_master_dsp_slave_ack, wb_s2m_dsp_master_dsp_slave_ack}),
    .wbm_err_o ({wb_s2m_daq_master_dsp_slave_err, wb_s2m_dsp_master_dsp_slave_err}),
    .wbm_rty_o ({wb_s2m_daq_master_dsp_slave_rty, wb_s2m_dsp_master_dsp_slave_rty}),
...
wb_arbiter
 ...
 wb_arbiter_daq_slave
   (.wb_clk_i  (wb_clk_i),
    .wb_rst_i  (wb_rst_i),
    .wbm_adr_i ({wb_m2s_daq_master_daq_slave_adr, wb_m2s_dsp_master_daq_slave_adr}),
    .wbm_dat_i ({wb_m2s_daq_master_daq_slave_dat, wb_m2s_dsp_master_daq_slave_dat}),
    .wbm_sel_i ({wb_m2s_daq_master_daq_slave_sel, wb_m2s_dsp_master_daq_slave_sel}),
    .wbm_we_i  ({wb_m2s_daq_master_daq_slave_we, wb_m2s_dsp_master_daq_slave_we}),
    .wbm_cyc_i ({wb_m2s_daq_master_daq_slave_cyc, wb_m2s_dsp_master_daq_slave_cyc}),
    .wbm_stb_i ({wb_m2s_daq_master_daq_slave_stb, wb_m2s_dsp_master_daq_slave_stb}),
    .wbm_cti_i ({wb_m2s_daq_master_daq_slave_cti, wb_m2s_dsp_master_daq_slave_cti}),
    .wbm_bte_i ({wb_m2s_daq_master_daq_slave_bte, wb_m2s_dsp_master_daq_slave_bte}),
    .wbm_dat_o ({wb_s2m_daq_master_daq_slave_dat, wb_s2m_dsp_master_daq_slave_dat}),
    .wbm_ack_o ({wb_s2m_daq_master_daq_slave_ack, wb_s2m_dsp_master_daq_slave_ack}),
    .wbm_err_o ({wb_s2m_daq_master_daq_slave_err, wb_s2m_dsp_master_daq_slave_err}),
    .wbm_rty_o ({wb_s2m_daq_master_daq_slave_rty, wb_s2m_dsp_master_daq_slave_rty}),
...
wb_arbiter
 ...
 wb_arbiter_ram0
   (.wb_clk_i  (wb_clk_i),
    .wb_rst_i  (wb_rst_i),
    .wbm_adr_i ({wb_m2s_daq_master_ram0_adr, wb_m2s_dsp_master_ram0_adr}),
    .wbm_dat_i ({wb_m2s_daq_master_ram0_dat, wb_m2s_dsp_master_ram0_dat}),
    .wbm_sel_i ({wb_m2s_daq_master_ram0_sel, wb_m2s_dsp_master_ram0_sel}),
    .wbm_we_i  ({wb_m2s_daq_master_ram0_we, wb_m2s_dsp_master_ram0_we}),
    .wbm_cyc_i ({wb_m2s_daq_master_ram0_cyc, wb_m2s_dsp_master_ram0_cyc}),
    .wbm_stb_i ({wb_m2s_daq_master_ram0_stb, wb_m2s_dsp_master_ram0_stb}),
    .wbm_cti_i ({wb_m2s_daq_master_ram0_cti, wb_m2s_dsp_master_ram0_cti}),
    .wbm_bte_i ({wb_m2s_daq_master_ram0_bte, wb_m2s_dsp_master_ram0_bte}),
    .wbm_dat_o ({wb_s2m_daq_master_ram0_dat, wb_s2m_dsp_master_ram0_dat}),
    .wbm_ack_o ({wb_s2m_daq_master_ram0_ack, wb_s2m_dsp_master_ram0_ack}),
    .wbm_err_o ({wb_s2m_daq_master_ram0_err, wb_s2m_dsp_master_ram0_err}),
    .wbm_rty_o ({wb_s2m_daq_master_ram0_rty, wb_s2m_dsp_master_ram0_rty}),
...
wb_arbiter
 ...
 wb_arbiter_ram1
   (.wb_clk_i  (wb_clk_i),
    .wb_rst_i  (wb_rst_i),
    .wbm_adr_i ({wb_m2s_daq_master_ram1_adr, wb_m2s_dsp_master_ram1_adr}),
    .wbm_dat_i ({wb_m2s_daq_master_ram1_dat, wb_m2s_dsp_master_ram1_dat}),
    .wbm_sel_i ({wb_m2s_daq_master_ram1_sel, wb_m2s_dsp_master_ram1_sel}),
    .wbm_we_i  ({wb_m2s_daq_master_ram1_we, wb_m2s_dsp_master_ram1_we}),
    .wbm_cyc_i ({wb_m2s_daq_master_ram1_cyc, wb_m2s_dsp_master_ram1_cyc}),
    .wbm_stb_i ({wb_m2s_daq_master_ram1_stb, wb_m2s_dsp_master_ram1_stb}),
    .wbm_cti_i ({wb_m2s_daq_master_ram1_cti, wb_m2s_dsp_master_ram1_cti}),
    .wbm_bte_i ({wb_m2s_daq_master_ram1_bte, wb_m2s_dsp_master_ram1_bte}),
    .wbm_dat_o ({wb_s2m_daq_master_ram1_dat, wb_s2m_dsp_master_ram1_dat}),
    .wbm_ack_o ({wb_s2m_daq_master_ram1_ack, wb_s2m_dsp_master_ram1_ack}),
    .wbm_err_o ({wb_s2m_daq_master_ram1_err, wb_s2m_dsp_master_ram1_err}),
    .wbm_rty_o ({wb_s2m_daq_master_ram1_rty, wb_s2m_dsp_master_ram1_rty}),
...
wb_arbiter
 ...
 wb_arbiter_ram2
   (.wb_clk_i  (wb_clk_i),
    .wb_rst_i  (wb_rst_i),
    .wbm_adr_i ({wb_m2s_daq_master_ram2_adr, wb_m2s_dsp_master_ram2_adr}),
    .wbm_dat_i ({wb_m2s_daq_master_ram2_dat, wb_m2s_dsp_master_ram2_dat}),
    .wbm_sel_i ({wb_m2s_daq_master_ram2_sel, wb_m2s_dsp_master_ram2_sel}),
    .wbm_we_i  ({wb_m2s_daq_master_ram2_we, wb_m2s_dsp_master_ram2_we}),
    .wbm_cyc_i ({wb_m2s_daq_master_ram2_cyc, wb_m2s_dsp_master_ram2_cyc}),
    .wbm_stb_i ({wb_m2s_daq_master_ram2_stb, wb_m2s_dsp_master_ram2_stb}),
    .wbm_cti_i ({wb_m2s_daq_master_ram2_cti, wb_m2s_dsp_master_ram2_cti}),
    .wbm_bte_i ({wb_m2s_daq_master_ram2_bte, wb_m2s_dsp_master_ram2_bte}),
    .wbm_dat_o ({wb_s2m_daq_master_ram2_dat, wb_s2m_dsp_master_ram2_dat}),
    .wbm_ack_o ({wb_s2m_daq_master_ram2_ack, wb_s2m_dsp_master_ram2_ack}),
    .wbm_err_o ({wb_s2m_daq_master_ram2_err, wb_s2m_dsp_master_ram2_err}),
    .wbm_rty_o ({wb_s2m_daq_master_ram2_rty, wb_s2m_dsp_master_ram2_rty}),
...
wb_arbiter
 ...
 wb_arbiter_ram3
   (.wb_clk_i  (wb_clk_i),
    .wb_rst_i  (wb_rst_i),
    .wbm_adr_i ({wb_m2s_daq_master_ram3_adr, wb_m2s_dsp_master_ram3_adr}),
    .wbm_dat_i ({wb_m2s_daq_master_ram3_dat, wb_m2s_dsp_master_ram3_dat}),
    .wbm_sel_i ({wb_m2s_daq_master_ram3_sel, wb_m2s_dsp_master_ram3_sel}),
    .wbm_we_i  ({wb_m2s_daq_master_ram3_we, wb_m2s_dsp_master_ram3_we}),
    .wbm_cyc_i ({wb_m2s_daq_master_ram3_cyc, wb_m2s_dsp_master_ram3_cyc}),
    .wbm_stb_i ({wb_m2s_daq_master_ram3_stb, wb_m2s_dsp_master_ram3_stb}),
    .wbm_cti_i ({wb_m2s_daq_master_ram3_cti, wb_m2s_dsp_master_ram3_cti}),
    .wbm_bte_i ({wb_m2s_daq_master_ram3_bte, wb_m2s_dsp_master_ram3_bte}),
    .wbm_dat_o ({wb_s2m_daq_master_ram3_dat, wb_s2m_dsp_master_ram3_dat}),
    .wbm_ack_o ({wb_s2m_daq_master_ram3_ack, wb_s2m_dsp_master_ram3_ack}),
    .wbm_err_o ({wb_s2m_daq_master_ram3_err, wb_s2m_dsp_master_ram3_err}),
    .wbm_rty_o ({wb_s2m_daq_master_ram3_rty, wb_s2m_dsp_master_ram3_rty}),
